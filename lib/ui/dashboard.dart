...
class _DashboardState extends State<Dashboard> {
  ...
  String _thinking = 'جاري تهيئة AI Core...';
  ...
  Future<void> _init() async {
    ...
    await _tts.init();
    setState(() {
      _thinking = '''🧠 AI Core OS V2 - هيكلة احترافية
المدخل: المستخدم
  ↓
AICore
  ├── Brain (تحليل)
...
أوفلاين 100% - بدون Gemini 🚀

جرب: "اسمي محمد" ثم "ما اسمي؟"''';
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('AI CORE OS V2 - PROFESSIONAL', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
